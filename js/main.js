	...
	githubRepos.run(function(data) {
		...
		for (var i = 0; i < data.length; i++) {
			if (!data[i].fork) {
				...
				modalhtml = modalhtml + '<li><a id="demo' + i + '" href="#repo' + i + 'Modal">' + data[i].name + '</a><div id="repo' + i + 'Modal"><div class="close-repo' + i + 'Modal modalclose"><img style="float: right;" src="img/close.png"/></div><div id="modal-' + data[i].name + '-content">' + data[i].git_url + '</div></div></li>';
			}
			projectCount += 1;
		}
